...
- [ ] Implement the new firmware ZOWI_DESKTOP_FW (base firmware refactoring)
...
- Translations are loaded from `.json` files at runtime. Fallback: English.
