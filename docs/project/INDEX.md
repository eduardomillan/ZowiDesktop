...
| [TRANSPORT_HOWTO.md](TRANSPORT_HOWTO.md) | Transport management (Bluetooth SPP / USB serial): situation state machine, registration flows, re-registration behavior, test checklist, persistence keys, UI integration, and CLI integration. |
