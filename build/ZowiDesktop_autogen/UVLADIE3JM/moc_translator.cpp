...
QT_MOC_LITERAL(4, 33, 6), // "locale"
QT_MOC_LITERAL(5, 40, 16), // "availableLocales"
QT_MOC_LITERAL(6, 57, 9), // "translate"
QT_MOC_LITERAL(7, 67, 7), // "context"
QT_MOC_LITERAL(8, 75, 6), // "source"
QT_MOC_LITERAL(9, 82, 13) // "currentLocale"

    },
    "Translator\0languageChanged\0\0load\0"
    "locale\0availableLocales\0translate\0"
    "context\0source\0currentLocale"
};
...
void Translator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { QStringList _r = _t->availableLocales();
        ...
        case 4: { QString _r = _t->currentLocale();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
